  ...
  return (
    <div className="space-y-12 lg:space-y-16">
      <section aria-labelledby="videos-featured-heading">
        <div className="mx-auto max-w-[1160px] overflow-hidden rounded-[36px] border border-[rgba(29,22,15,0.1)] bg-white p-4 shadow-[0_28px_60px_rgba(29,22,15,0.08)] sm:p-5">
          <div className="mb-8 max-w-[720px]">
            ...
            <p className="max-w-[560px] text-[15px] leading-7 text-[var(--ink-muted)]">
              {feed.featuredVideo?.description ?? 'Start with the newest featured guidance, then browse the rest of the library below.'}
            </p>
          </div>

          <div className="grid gap-6 lg:grid-cols-[minmax(0,1.18fr)_340px] lg:items-stretch">
            <YouTubeEmbed
            ...
            <aside className="flex h-full flex-col rounded-[28px] border border-[rgba(29,22,15,0.08)] bg-[#fffaf4] p-6 sm:p-7 lg:justify-between">
              <div className="mb-3 text-[12px] font-bold uppercase tracking-[0.14em] text-[#8d5c22]">
                Watch next
              </div>
              <p className="mb-6 max-w-[28ch] text-[15px] leading-7 text-[var(--ink-muted)]">
      ...
      {feed.videos.length > 0 ? (
        <section aria-labelledby="all-videos-heading">
          ...
          <ul className="mx-auto grid max-w-[1160px] gap-6 md:grid-cols-2 xl:grid-cols-3">
