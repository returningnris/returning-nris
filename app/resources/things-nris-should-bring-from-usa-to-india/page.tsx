    ...
    <>
      ...
      <article style={{ background: '#fff', padding: '2.5rem 2rem 3rem' }}>
        <div style={prose}>
          ...
          <div style={{ background: '#F8F5F0', border: '1px solid #E5E1DA', borderRadius: '16px', padding: '1.25rem 1.35rem', margin: '1.25rem 0 1.75rem' }}>
            <div style={{ fontSize: '11px', fontWeight: 700, color: '#6B5E50', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.7rem' }}>Our step-down transformer picks</div>
            <p style={{ ...paragraph, marginBottom: '0.85rem', fontSize: '0.94rem' }}>Choose the capacity only after checking your appliance&apos;s rated wattage. These are practical options for US-voltage appliances being used in India:</p>
            <div style={{ display: 'grid', gap: '0.65rem' }}>
              <a href="https://www.amazon.in/dp/B095BRQN15/ref=cm_sw_r_as_gl_api_gl_i_JK6QZDPH0S9J2DB0A3XC?linkCode=ml1&tag=swathibharath-21&linkId=062aac0dde594bcc80067b0e1371b589&ascsubtag=srctok-3dc593722c7549b3&btn_type=ss&btn_ref=srctok-3dc593722c7549b3&th=1" target="_blank" rel="sponsored noopener noreferrer" style={{ color: '#1A1208', textDecoration: 'none', background: '#fff', border: '1px solid #E5E1DA', borderRadius: '10px', padding: '0.8rem 0.9rem' }}><strong>AXVOLT Crysta 2000W</strong><span style={{ display: 'block', fontSize: '0.85rem', color: '#6B5E50', marginTop: '0.15rem' }}>Higher-capacity option for compatible higher-wattage appliances</span></a>
              <a href="https://www.amazon.in/dp/B08ZSDNHDV/ref=cm_sw_r_as_gl_api_gl_i_FX8MCQSEK82HCMWMPRY4?linkCode=ml1&tag=swathibharath-21&linkId=bd83fe20a725571548378a1d870484ac&ascsubtag=srctok-7921cecb50af5c2b&btn_type=ss&btn_ref=srctok-7921cecb50af5c2b&th=1" target="_blank" rel="sponsored noopener noreferrer" style={{ color: '#1A1208', textDecoration: 'none', background: '#fff', border: '1px solid #E5E1DA', borderRadius: '10px', padding: '0.8rem 0.9rem' }}><strong>AXVOLT Crysta 1500W</strong><span style={{ display: 'block', fontSize: '0.85rem', color: '#6B5E50', marginTop: '0.15rem' }}>Mid-capacity option for compatible appliances</span></a>
              <a href="https://www.amazon.in/dp/B08ZS4V6ZF/ref=cm_sw_r_as_gl_api_gl_i_QK33E7YFMA7NG3EPDE8D?linkCode=ml1&tag=swathibharath-21&linkId=ff6b32bc39aa2eb00d0e65ad59929db6&ascsubtag=srctok-47f03282f165341a&btn_type=ss&btn_ref=srctok-47f03282f165341a&th=1" target="_blank" rel="sponsored noopener noreferrer" style={{ color: '#1A1208', textDecoration: 'none', background: '#fff', border: '1px solid #E5E1DA', borderRadius: '10px', padding: '0.8rem 0.9rem' }}><strong>AXVOLT Crysta 600W</strong><span style={{ display: 'block', fontSize: '0.85rem', color: '#6B5E50', marginTop: '0.15rem' }}>Lower-power option for compatible appliances</span></a>
            </div>
            <p style={{ fontSize: '0.78rem', color: '#6B5E50', lineHeight: 1.6, margin: '0.85rem 0 0' }}>Affiliate note: these are Amazon affiliate links. We may earn a small commission at no extra cost to you.</p>
          </div>
